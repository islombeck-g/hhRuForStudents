...
struct enterView_02_02: View {
    ...
    @Binding public var selectedUnivercity: String
    
    @Binding public var phoneNumber: String
    @Binding public var isMarkedStudent:Bool
    
    
    @Binding public var nameOfCompany:String
    let cities = [
      "Москва",
      "Санкт-Петербург",
      "Новосибирск",
            ...
            VStack{
                ...
                Group{
                    ...
                    if isMarkedStudent == true{
                        ...
                        TextField("Название компании*", text: $nameOfCompany)
                            .padding()
                            .frame(width: geometry.size.width-50, height: 46)
                            .overlay(RoundedRectangle(cornerRadius: 10.0).strokeBorder(Color.black, style: StrokeStyle(lineWidth: 2.0)))
                    }
